...
const translations: Translations = {
    en: {
        ...
        products: 'Produk',
        about: 'Tentang Kami',
        sustainability: 'Produk Unggulan',
        contact: 'Kontak',

        // Hero Section
        heroTitle: 'Langkah Pasti & Bergaya,',
        heroTitleHighlight: 'Teman Setia Aktivitas Sehari-Hari',
        heroDescription:
            'Nikmati koleksi alas kaki yang ergonomis, trendi, dan siap menemani setiap langkah aktif Anda. Produk kami dibuat dengan material pilihan berkualitas tinggi dan dirancang khusus agar tetap nyaman, sehingga Anda bisa terus bergerak dengan percaya diri.',
        ecoFriendly: 'Kualitas Premium',
        sustainablePackaging: 'Material pilihan & tahan lama',
        longLasting: 'Nyaman & Ringan',
        shelfLife: 'Beban minimal di setiap langkah',
        nutrientRich: 'Desain Ergonomis',
        nutritionRetained: 'Riset bentuk kaki yang presisi',
        accessible: 'Mudah Dipadukan',
        easyPreparation: 'Cocok untuk berbagai gaya',
        checkOurProducts: 'Cek Koleksi Kami',
        shopNow: 'Shop Now',
        learnMore: 'Lebih Lanjut',
        freeShipping: 'Pengiriman Gratis',
        dayReturns: 'Garansi Ukuran 30 Hari',
        natural: '100% Original',
        ...
        newsletterDesc:
            'Dapatkan informasi terbaru tentang produk lokal unggulan, promo menarik, dan koleksi terbaru dari KUB Mampu Jaya.',
        subscribe: 'Ikuti',
